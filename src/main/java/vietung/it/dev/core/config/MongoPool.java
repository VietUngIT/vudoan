...
public class MongoPool {
    ...
    public static void newConnection(){
        ...
        mongoClient = new MongoClient(new ServerAddress(MongoConfig.MONGODB_HOST,MongoConfig.MONGODB_PORT), Arrays.asList(credential));
    }
    ...
    public static DB getDBJongo() {
        if (mongoClient == null) {
            MongoPool.newConnection();
        }
        return mongoClient.getDB(MongoConfig.MONGODB_DATABASE);
    }
}
