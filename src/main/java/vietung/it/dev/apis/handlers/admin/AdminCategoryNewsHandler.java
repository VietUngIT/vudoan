...
public class AdminCategoryNewsHandler extends BaseApiHandler {
    @Override
    public BaseResponse handle(HttpServerRequest request) throws Exception {
        ...
        if(type!=null){
            if(type.equals("add")){
                ...
                if(strName!=null){
                    return service.addCategoryNews(strName);
                }
                ...
                if(id!=null && strNewName!=null){
                    return service.editCategoryNews(id,strNewName);
                }
                return Utils.notifiError(ErrorCode.INVALID_PARAMS,"Invalid params.");
            }else if(type.equals("del")){
                String id = request.getParam("id");
                if(id!=null){
                    return service.deleteCategoryNews(id);
                }
                return Utils.notifiError(ErrorCode.INVALID_PARAMS,"Invalid params.");
            }else{
                return Utils.notifiError(ErrorCode.INVALID_PARAMS,"Invalid params.");
