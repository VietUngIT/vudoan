...
public class AdminCateAgriTechHandler extends BaseApiHandler {
    @Override
    public BaseResponse handle(HttpServerRequest request) throws Exception {
        ...
        if(type!=null){
            if(type.equals("add")){
                ...
                if(strName!=null){
                    return service.addCategoryAgriTech(strName);
                }
                ...
                if(id!=null && strNewName!=null){
                    return service.editCategoryAgriTech(id,strNewName);
                }
                return Utils.notifiError(ErrorCode.INVALID_PARAMS,"Invalid params.");
            }else if(type.equals("del")){
                String id = request.getParam("id");
                if(id!=null){
                    return service.deleteCategoryAgriTech(id);
                }
                return Utils.notifiError(ErrorCode.INVALID_PARAMS,"Invalid params.");
            }else{
                return Utils.notifiError(ErrorCode.INVALID_PARAMS,"Invalid params.");
